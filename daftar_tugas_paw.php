...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link active" href="daftar_tugas_paw.php"><b>Daftar Tugas PAW</b></a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <center><h1><b>Daftar Tugas Pengembangan Aplikasi Web</b></h1></center>
  ...
  -->
  <form method="post" action="add_tugas_paw.php">
  ...
  <table class="table table-warning" border="5" width="50%">
    ...
    $q = $conn->query("SELECT * FROM daftar_tugas_paw");
    $no = 1; // nomor urut
    ...
    <tr>  
      ...
      <td><a class="btn btn-primary btn-lg" href="update_tugas_paw.php?id=<?= $dt['id_tugas'] ?>">Ubah</a></td>
      <td><a class="btn btn-danger btn-lg" href="delete_tugas_paw.php?id=<?= $dt['id_tugas'] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a></td>
    </tr>
    <?php
    endwhile;
    ?> 
